...
const DashboardScreen = () => {
  ...
  // NEW: Determine correct columns for phone/tablet + portrait/landscape
  const getColumns = () => {
    if (isTab && isLandscape) return 4; // Tablet landscape
    if (isTab && !isLandscape) return 2; // Tablet portrait
    if (!isTab && isLandscape) return 2; // Phone landscape
